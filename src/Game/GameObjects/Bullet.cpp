...
Bullet::Bullet(const double velocity, const glm::vec2 &position, const glm::vec2 &size, const float layer) noexcept 
  : IGameObject(IGameObject::EObjectType::Bullet, position, size, 0.f, layer), m_pSprite_top(ResourceManager::getSprite("bullet_Top")), 
