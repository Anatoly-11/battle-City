...
BrickWall::EBrickState BrickWall::getBrickStateAfterCollision(const EBrickState currentState,
...
Physics::AABB BrickWall::getAABBForBrickState(const EBrickLocation location, const EBrickState eBrickState,
...
void BrickWall::onCollisionCallback(const EBrickLocation location, const IGameObject &object,
  const Physics::ECollisionDirection direction) noexcept {
...
BrickWall::BrickWall(const EBrickWallType eBrickWallType, const glm::vec2 &position, const glm::vec2 &size, const float rotation,
  const float layer) noexcept : IGameObject(IGameObject::EObjectType::BrickWall, position, size, rotation, layer),
  m_eCurrentBrickState{EBrickState::Destroyed, EBrickState::Destroyed, EBrickState::Destroyed, EBrickState::Destroyed},
  m_blockOffsets{glm::vec2(0, m_size.y / 2.f), glm::vec2(m_size.x / 2.f, m_size.y / 2.f),
  glm::vec2(0, 0),
